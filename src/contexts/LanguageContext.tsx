...
const translations = {
  en: {
    ...
    "hero.description": "Quality-focused QA Engineer with experience in mobile banking applications, transitioning into test automation and building reliable E2E solutions.",
    ...
    "experience.company": "Banking Sector",
    "experience.period": "6 months",
    "experience.desc": "Testing business-critical mobile banking applications in a regulated enterprise environment.",
    "experience.point1": "Manual testing of mobile applications (iOS / Android)",
    "experience.point2": "Work in a regulated, enterprise environment",
    "experience.point3": "Testing business-critical user flows",
    "experience.point4": "Close collaboration with developers, analysts, and QA teams",
  ...
  pl: {
    ...
    "hero.description": "Inżynier QA zorientowany na jakość z doświadczeniem w mobilnych aplikacjach bankowych, przechodzący do automatyzacji testów i budujący niezawodne rozwiązania E2E.",
    ...
    "experience.company": "Sektor Bankowy",
    "experience.period": "6 miesięcy",
    "experience.desc": "Testowanie krytycznych biznesowo mobilnych aplikacji bankowych w regulowanym środowisku korporacyjnym.",
    "experience.point1": "Testowanie manualne aplikacji mobilnych (iOS / Android)",
    "experience.point2": "Praca w regulowanym środowisku enterprise",
    "experience.point3": "Testowanie krytycznych ścieżek użytkownika",
